...
//Notify
$.notify({
	icon: '<i class="fas fa-bell"></i>', // Use proper icon class (Font Awesome example)
	title: 'Welcome!',
	message: 'You have successfully logged in.',
  }, {
	type: 'success', // Optional: Set the notification type (e.g., success, warning, danger)
	placement: {
	  from: "top",
	  align: "right"
	},
	icon_type: 'html' // Ensures the icon is treated as HTML
  })
  ,{
	type: 'secondary',
	placement: {
